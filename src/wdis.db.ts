...
import { MetaModelManager } from './resource/meta.model.manager';
import { Create } from './resource/query/create';
import { Resource } from './resource/resource';
import { META_MODEL_MANAGER } from './resource/resource.constants';
...
export class WdisDb {
    ...
    public metaModel(modelName:string, model:any):MetaModel {
        return (this.resource.get(META_MODEL_MANAGER)() as MetaModelManager).metaModel(modelName, model);
    }
