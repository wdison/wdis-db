...
describe('PostgresInsert', () => {
    beforeAll(async () => {
        console.log('PostgresInsert beforeAll');
        ...
        let sqls = [
            ...
            `INSERT INTO perfil_insert (id, cd, name, dt_create) VALUES (1, 'ADMIN', 'Administrator', CURRENT_DATE)`,
            `INSERT INTO perfil_insert (id, cd, name, dt_create) VALUES (2, 'USER', 'User', CURRENT_DATE)`,
            `INSERT INTO perfil_insert (id, cd, name, dt_create) VALUES (3, 'VIEW', 'View', CURRENT_DATE)`,
    ...
    describe('when insert user', () => {
        ...
        it('Should insert User from select', async () => {
            ...
            expect(renderedSql).toContain('user_insert');
            expect((await insert.run())).toEqual(expect.objectContaining({
                rowCount: 3, //3 inserts in sql from top of this file
            }))
        })
    });
});